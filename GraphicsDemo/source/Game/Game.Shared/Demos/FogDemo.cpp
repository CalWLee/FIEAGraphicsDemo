...
namespace Rendering
{
	...
	FogDemo::FogDemo(Game::GameBase& game, Camera& camera)
	...
	void FogDemo::Initialize()
	{
		...
		std::string compiledVertexShader = Utility::LoadBinaryFile("Content\\Shaders\\FogVertexShader.cso");
		...
		std::string compiledPixelShader = Utility::LoadBinaryFile("Content\\Shaders\\FogPixelShader.cso");
	...
	void FogDemo::CreateVertexBuffer(ID3D11Device* device, const Mesh& mesh, ID3D11Buffer** vertexBuffer) const
	{
