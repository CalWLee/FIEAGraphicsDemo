...
namespace Rendering
{
	...
	BlinnPhongDemo::BlinnPhongDemo(Game::GameBase& game, Camera& camera)
	...
	void BlinnPhongDemo::Initialize()
	{
		...
		std::string compiledVertexShader = Utility::LoadBinaryFile("Content\\Shaders\\BlinnPhongVertexShader.cso");
		...
		std::string compiledPixelShader = Utility::LoadBinaryFile("Content\\Shaders\\BlinnPhongPixelShader.cso");
	...
	void BlinnPhongDemo::CreateVertexBuffer(ID3D11Device* device, const Mesh& mesh, ID3D11Buffer** vertexBuffer) const
	{
