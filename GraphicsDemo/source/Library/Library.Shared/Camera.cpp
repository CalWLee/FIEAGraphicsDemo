...
namespace Library
{
	...
	bool Camera::CameraControlFlag = false;

	Camera::Camera(Game::GameBase& game)
        : GameComponent(game),
	...
	Camera::Camera(Game::GameBase& game, float fieldOfView, float aspectRatio, float nearPlaneDistance, float farPlaneDistance)
        : GameComponent(game),
