...
namespace Library
{
    ...
    public:
		Camera(Game::GameBase& game);
		Camera(Game::GameBase& game, float fieldOfView, float aspectRatio, float nearPlaneDistance, float farPlaneDistance);
