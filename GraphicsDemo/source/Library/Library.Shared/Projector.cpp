...
namespace Library
{
	...
	Projector::Projector(Game::GameBase& game)
        : GameComponent(game),
	...
	Projector::Projector(Game::GameBase& game, float fieldOfView, float aspectRatio, float nearPlaneDistance, float farPlaneDistance)
        : GameComponent(game),
